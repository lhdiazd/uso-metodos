...
//item 1
traumatologia.push(...nuevosRegistrosTraumatologia);
...
//item 3 
document.write('<hr>');
document.write(`<p>Consulta dental: </p>`)
dental.forEach(consulta => {
    const cadenaConsulta = Object.values(consulta).join(' - ');
    document.write(cadenaConsulta + '<br>');
});
...
//item 4
document.write('<hr>');
document.write(`<p>Listado de pacientes atendidos: </p>`)
radiologia.concat(traumatologia, dental).forEach(consulta => {
    const paciente = consulta.paciente;
    document.write(paciente + '<br>');
})


//item 5
document.write('<hr>');
document.write(`<p>Pacientes ISAPRE dental: </p>`)
let pacientesIsapre = dental.filter(consulta => consulta.prevision.toLowerCase() === 'isapre');
pacientesIsapre.forEach(consulta => {
    const cadenaConsulta = `${consulta.paciente} - ${consulta.prevision}`;
    document.write(`<p>${cadenaConsulta}</p>`);
});

//item 6
document.write('<hr>');
document.write(`<p>Pacientes FONASA Traumatología: </p>`)
let pacientesFonasa = traumatologia.filter(consulta => consulta.prevision.toLowerCase() === 'fonasa');
